...
namespace Chapter3
{
    public partial class Task2 : Form
    {
        ...
        private void SentData(string text)
        {
            byte[] msg;
        ...
        private void Explore()
        {
            ...
            while (_exit == false)
            {
                ...
                if (_applications.Available > 0)
                {
                    ...
                    if (str.Contains("Computer")) SentData("Máy tính");
                    if (str.Contains("RAM")) SentData("Bộ nhớ RAM");
                    if (str.Contains("HDD")) SentData("Ổ cứng HDD");
                    if (!str.Contains(' ')) SentData("Not found");
                }
            }
        }
